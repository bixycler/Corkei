...
import {FabrikContext, FabrikContextValue} from "./FabrikDemo-SolidD3/FabrikContext";
import FabrikCanvas    from "./FabrikDemo-SolidD3/FabrikCanvas";
import {useFabrikChain}  from "./FabrikDemo-SolidD3/FabrikChain";
...
export default function FabrikDemoSolidD3(){
  ...
  return (
    <FabrikContext.Provider value={FabrikContextValue}>
