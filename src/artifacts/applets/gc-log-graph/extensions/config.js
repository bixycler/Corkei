...
// Helper for size formatting used across extensions
...
// Helper for count formatting (e.g. 1.2k, 2.5M)
export function formatCountHuman(count) {
...
// Helper for duration formatting (microseconds or milliseconds)
// If input is >= 1000, assumes milliseconds; otherwise assumes microseconds
export function formatDurationHuman(value, unit = 'auto') {
  let ms;
...
// Helper for timestamp formatting that respects timezone selection
export function formatTimestampInTz(date, rawStr) {
